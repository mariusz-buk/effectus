...
procedure RunMADS(srcFilename, srcExtx, binExtx, logFilename : string);
...
var lst, lab, hhh, mmm: textfile;
    ...
    logList : TStringList;
    logAllFile : TFileStream;
    logFile: string;
    CreateMode: Word;
    tempLogFile : string;
    
    srcFile : string;
    srcExt, binExt : string;
...
//  __long   = $B1;
  ...
  __over   = __longi;	// koniec kodow dyrektyw
...
begin
 ...
 //TextBuf += result + #13#10;
 //AStringList.Add(result);  // + #13#10);
end;
...
//TextBuf += a;
 ...
 TempLogList.Add(a);
  //LogAllFile.Write(Pointer(a)^, Length(a)); 
...
//    if messages[b].pas=messages[a].pas then
  ...
  LogList.AddStrings(TempLogList);
  LogList.SaveToFile(logFile);
  if Assigned(LogList) then LogList.Free;

  // Save output to a file.
  TempLogList.SaveToFile(tempLogFile);
  if Assigned(TempLogList) then TempLogList.Free;
...
begin
 ...
 while i<=len do begin
  ...
  case a[i] of
   ...
   '.','$'{,'%'}:  // błąd jeśli po znakach '.', '$' jest "biały znak"
...
procedure INITIALIZE(srcFilename : string);
(*----------------------------------------------------------------------------*)
...
const
 ...
 (v:$B0;o:$A307),(v:$C1;o:$A3EE),(v:$BB;o:$A421),(v:$65;o:$A934),(v:$B4;o:$A9FB),(v:$66;o:$AB24),
 (v:$AD;o:$ACD0),(v:$64;o:$AFC6),(v:$BE;o:$B2B3),(v:$BD;o:$B633),(v:$E3;o:$B64B),(v:$CF;o:$B904),
 (v:$AE;o:$B9DA),(v:$C5;o:$B9F0),(v:$0A;o:$BA05),(v:$DD;o:$BA64),(v:$E4;o:$BEEA),(v:$CC;o:$BFBD),
 (v:$C0;o:$C10A),(v:$73;o:$C257),(v:$75;o:$CA0E),(v:$6E;o:$CA5A),(v:$09;o:$CC30),(v:$C8;o:$CD5F),
 (v:$66;o:$CDE6),(v:$A1;o:$CE0D),(v:$C3;o:$CF8A),(v:$6C;o:$D040),(v:$E6;o:$D090),(v:$B1;o:$D0C2),
 (v:$6B;o:$D0CD),(v:$D8;o:$D417),(v:$04;o:$D720),(v:$6C;o:$D894),(v:$CF;o:$D91C),(v:$D8;o:$DB0C),
 (v:$CE;o:$DE1A),(v:$B3;o:$E073),(v:$E2;o:$E10B),(v:$6A;o:$E3FC),(v:$0E;o:$E6E6),(v:$D0;o:$E767),
 (v:$B4;o:$E829),(v:$CD;o:$E97F),(v:$0C;o:$EA8C),(v:$C4;o:$EB60),(v:$C3;o:$EBA8),(v:$08;o:$EDEE),
 (v:$07;o:$EFC3),(v:$C7;o:$F129),(v:$72;o:$F166),(v:$CC;o:$F1FE),(v:$AA;o:$F353),(v:$64;o:$F5F1),
 (v:$A8;o:$F6D0),(v:$D0;o:$F6E5),(v:$C0;o:$F88C),(v:$B5;o:$FAC5),(v:$01;o:$FC2A),(v:$D2;o:$FCCE)
 );
...
//_i = 2t[_i] = o
  ...
  plik_asm:='';
  arr[1] := srcFilename + '.' + srcExt;
  arr[2] := '-o:' + srcFilename + '.' + binExt;
  
  srcFile := arr[1];

 // odczyt parametrow
 for IORes:=1 to 2 do begin  // ParamCount
  //t:=ParamStr(IORes);
  t := arr[IORes];
  //writeln('t = *' + t + '*');
...
{$else}
  tempLogFile := GetCurrentDir + PathDelim + 'templog.txt';
{$endif}

  TempLogList := TStringList.Create;
  LogList := TStringList.Create;

  // Check to see if log file has to be created
  if FileExists(LogFile) then
    CreateMode := fmOpenReadWrite or fmShareDenyWrite
  else begin
    CreateMode := fmCreate or fmShareDenyWrite;
  end;
  LogAllFile := TFileStream.Create(LogFile, CreateMode);
  if assigned(LogAllFile) then begin
    LogAllFile.Free;
  end;
...
(*----------------------------------------------------------------------------*)
 ...
 TempLogList.Add('-----------------------------------------');
 tempLogList.Add('Filename: ' + srcFile);
 tempLogList.Add(FormatDateTime('c', Now));
 ...
 asem(plik_asm);
  ...
  //WriteLn('tempLogFile = ', tempLogFile);

  // Redirect current output to the archive log
{$ifdef Unix}
  AProcess.Executable := '/bin/sh';
  AProcess.Parameters.Add('-c');
  //AProcess.Parameters.Add('cat ' + tempLogFile + ' >> effectus.log');
  AProcess.Parameters.Add('cat ' + tempLogFile + ' >> ' + logFilename);
{$else}
  AProcess.Executable := 'cmd.exe';
  AProcess.Parameters.Add('/c');
  AProcess.Parameters.Add('"type ' + tempLogFile + ' >> ' + logFilename + '"');
{$endif}
