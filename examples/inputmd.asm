 ...
 .array str_buffer1_eff_ [255] .byte = $ff
 .end
...
; using InputMD procedure for reading
; text file
...
MAIN_reff_
 ...
 jsr printf
 dta c'using InputMD procedure for reading',$9b,0
 jsr printf
 ...
 jmi stop1
 jsr printf
 dta c'InputMD example:',$9b,0
 PutE
 Read #16, #5, #str_buffer1_eff_, #254
 jsr printf
 dta c'#',$9b,0
